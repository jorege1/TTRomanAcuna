...
SECRET_KEY = 'django-insecure-*oj8^+q7w9$330a3f=tc6s=-dhyiyulll$*r_b28vel3jo)%4f'
...
TEMPLATE_DIR = os.path.join(CORE_DIR, "tesis/templates")
...
EMAIL_HOST_USER = 'rodrigoa367@outlook.com'
EMAIL_HOST_PASSWORD = 'nier_replicantv2.3'
EMAIL_PORT = 25